...
const Videos = () => {
  return (
    <div className='flex w-screen h-[50vh] items-center justify-center my-[100px]'>
      <div className='flex flex-col w-[70%] items-center justify-center text-center gap-[50px] lg:gap-[100px]'>
        ...
        <div className='grid grid-cols-3 w-full items-center justify-center gap-[20px]'>
        <iframe
