...
const VideoSection = () => {
  return (
    <div className='flex w-screen h-[50vh] bg-cover bg-center parallax items-center justify-center relative mt-[50px] lg:mt-[100px]' style={{ backgroundImage: `url(${img.src})` }}>
