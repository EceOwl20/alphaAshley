...
const Footer = () => {
  return (
    <div className="flex flex-col w-screen min-h-screen items-center justify-center bg-white">
      {/* Section 1 */}
      <div className="flex w-[80%] py-[82px] items-start justify-start text-start gap-[40px] text-lightGray">
        <div className="flex flex-col w-[25%] lg:max-w-[295px] items-start text-start justify-start gap-[25px]">
          <p className="text-[12px] font-roboto text-[] font-roboto font-normal leading-[20px]">
          ...
          <div className="flex w-full gap-[10px] items-start justify-start">
        ...
        <div className="flex h-[150px] w-[1px] bg-[#EDEDED]"></div>
        <div className="flex flex-col w-[25%] lg:max-w-[300px] items-start text-start justify-center gap-[10px]">
        ...
        <div className="flex flex-col w-[25%] lg:max-w-[300px] items-start text-start justify-center">
      ...
      <div className="flex w-full ">
        <div className="flex w-[50%] bg-black items-center justify-center">
      ...
      {/* Section 3 */}
      <div className="flex w-full items-center justify-center bg-[#f7f7f7] h-[120px]">
