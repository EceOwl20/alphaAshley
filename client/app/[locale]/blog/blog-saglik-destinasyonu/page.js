...
const page = () => {
  ...
  return (
    <div>
      <SubBlogSection img={img3} header="Antalya'yı Keşfetmek: Sağlık Destinasyonu"
       text="Akdeniz'in muhteşem sahil şeridi boyunca yer alan Antalya, sadece nefes kesen doğal güzelliği ile değil, aynı zamanda yenilenme ve rahatlama arayan gezginler için çeşitli sağlık ve wellness deneyimleri sunmasıyla da dikkat çekiyor. İşte Antalya'nın neden sağlık ve wellness turizminin önde gelen bir destinasyonu haline geldiğine dair bazı nedenler:" 
       text2="Antalya'nın doğal güzelliği, kültürel zenginliği ve wellness tekliflerinin uyumlu birleşimi, bedeninizi, ruhunuzu ve zihninizizi yenilemek isteyenler için ideal bir destinasyon yapar. Bakir plajlarda dinlenmek, holistik wellness geri çekilmelerine katılmak veya antik kalıntıları keşfetmek istiyorsanız, Antalya, sağlık ve refah yolculuğunuzda dönüştürücü bir deneyim sunar." array={array}/>
    </div>
  )
}
