...
const TextSection = ({header,text,link, mailText}) => {
  ...
  return (
    <div className='flex w-screen items-center justify-center py-5 lg:py-0 lg:h-[70vh]'>
      <div className='flex flex-col w-[90%] lg:w-[50%] items-center justify-center text-center gap-[20px] lg:gap-[45px]'>
        ...
        {link && (
           <p className='max-w-[912px] text-[20px] lg:text-[24px] text-lightGray font-normal leading-[24px]'> {t("note")} <Link  href="mailto:info.alphaashley@gmail.com" className='hover:text-[#ff214f]'>info.alphaashley@gmail.com{" "}</Link></p>
        )}
      </div>
    </div>
  )
